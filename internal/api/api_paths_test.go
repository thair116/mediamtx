...
func (m *testPathManager) APIKeepaliveAdd(defs.PathAccessRequest) (uuid.UUID, error) {
	return uuid.Nil, fmt.Errorf("not implemented")
}

func (m *testPathManager) APIKeepaliveRemove(uuid.UUID, defs.PathAccessRequest) error {
	return fmt.Errorf("not implemented")
}

func (m *testPathManager) APIKeepalivesList() (*defs.APIKeepaliveList, error) {
	return nil, fmt.Errorf("not implemented")
}

func (m *testPathManager) APIKeepalivesGet(uuid.UUID) (*defs.APIKeepalive, error) {
	return nil, fmt.Errorf("not implemented")
}
