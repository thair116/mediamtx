...
func (pa *path) initialize() {
	...
	pa.chDescribe = make(chan defs.PathDescribeReq, 32)
	pa.chAddPublisher = make(chan defs.PathAddPublisherReq, 32)
	pa.chRemovePublisher = make(chan defs.PathRemovePublisherReq, 32)
	pa.chAddReader = make(chan defs.PathAddReaderReq, 32)
	pa.chRemoveReader = make(chan defs.PathRemoveReaderReq, 32)
