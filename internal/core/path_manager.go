...
func (pm *pathManager) initialize() {
	...
	pm.chClosePath = make(chan *path, 32)
	pm.chPathReady = make(chan *path, 32)
	pm.chPathNotReady = make(chan *path, 32)
	pm.chFindPathConf = make(chan defs.PathFindPathConfReq, 32)
	pm.chDescribe = make(chan defs.PathDescribeReq, 32)
	pm.chAddReader = make(chan defs.PathAddReaderReq, 32)
	pm.chAddPublisher = make(chan defs.PathAddPublisherReq, 32)
