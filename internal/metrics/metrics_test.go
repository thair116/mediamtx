...
func (dummyPathManager) APIKeepaliveAdd(defs.PathAccessRequest) (uuid.UUID, error) {
	return uuid.Nil, fmt.Errorf("not implemented")
}

func (dummyPathManager) APIKeepaliveRemove(uuid.UUID, defs.PathAccessRequest) error {
	return fmt.Errorf("not implemented")
}

func (dummyPathManager) APIKeepalivesList() (*defs.APIKeepaliveList, error) {
	return nil, fmt.Errorf("not implemented")
}

func (dummyPathManager) APIKeepalivesGet(uuid.UUID) (*defs.APIKeepalive, error) {
	return nil, fmt.Errorf("not implemented")
}

func (emptyPathManager) APIKeepaliveAdd(defs.PathAccessRequest) (uuid.UUID, error) {
	return uuid.Nil, fmt.Errorf("not implemented")
}

func (emptyPathManager) APIKeepaliveRemove(uuid.UUID, defs.PathAccessRequest) error {
	return fmt.Errorf("not implemented")
}

func (emptyPathManager) APIKeepalivesList() (*defs.APIKeepaliveList, error) {
	return nil, fmt.Errorf("not implemented")
}

func (emptyPathManager) APIKeepalivesGet(uuid.UUID) (*defs.APIKeepalive, error) {
	return nil, fmt.Errorf("not implemented")
}
