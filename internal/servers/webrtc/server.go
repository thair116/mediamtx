...
func (s *Server) Initialize() error {
	...
	s.chNewSession = make(chan webRTCNewSessionReq, 32)
	s.chCloseSession = make(chan *session, 32)
	s.chAddSessionCandidates = make(chan webRTCAddSessionCandidatesReq, 32)
	s.chDeleteSession = make(chan webRTCDeleteSessionReq, 32)
